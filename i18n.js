...
(function () {
  ...
  const dict = {
    zh: {
      ...
      'events.tag':          '讲座与工作坊',
      'events.ev0.tag':     '发布会',
      'events.ev0.title':   '健康生活方式医学培训（正念静观心理专题）',
      'events.ev0.desc':    '中国正念静观生活协作网络筹建倡议发布仪式',
      'events.ev0.date':    '📅 2026年3月27日 · 北京',
      'events.ev0.loc':     '📍 阜外西园东街1号A座AB报告厅',
      'events.ev0.org':     '🏛️ 主办方：国家心血管疾病中心',
      ...
      'book2.title':   '牛津大学正念课：重建生命的智慧',
      'book2.author':  '克里斯蒂娜·费尔德曼 · 威廉·库肯 著 | 马嘉瞳 译',
      'book2.desc':    '重建生命的智慧，陪伴我们穿越苦恼与苦痛，为更好地掌控人生提供路线图。',
      'book2.reason':  '融合古老智慧和心理学知识，活出友善、慈悲、喜悦和平等心。',
      'book3.title':   '正念的奇迹',
      'book3.author':  '一行禅师',
      ...
      'about.volunteer.desc':  '加入志愿者团队，不仅仅让自己在服务中持续深化正念的学习，更有意义的是帮助更多人了解正念，从正念中受益。特别感谢参与书及视频翻译、支持威廉正念生活中国行的众多志愿者：王海兰、Xinyi、柳懿轩、王耀坤、杨漪、Cici。',
    ...
    en: {
      ...
      'events.ev0.tag':     'Launch Event',
      'events.ev0.title':   'Lifestyle Medicine Training (Mindfulness Psychology)',
      'events.ev0.desc':    'Launch Ceremony of the China Mindful Living Collaboration Network',
      'events.ev0.date':    '📅 March 27, 2026 · Beijing',
      'events.ev0.loc':     '📍 Hall AB, Building A, Fuwai West Garden East Street No.1',
      'events.ev0.org':     '🏛️ Organizer: National Center for Cardiovascular Diseases',
      ...
      'courses.c2.tag':  'Take it Further',
      ...
      'teacher2.role': 'MfL China Coordinator',
      ...
      'courses.c2.tag':  'Take it Further', 'courses.c2.meta': 'MBCT-L · 8-Week',
